...
using System.Linq;
using AutoLotDAL_ADO.BulkImport;
using AutoLotDAL_ADO.DataOperations;
using AutoLotDAL_ADO.Models;

namespace AutoLotClient_ADO
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var itm in list) Console.WriteLine($"{itm.CarId}\t{itm.Make}\t{itm.Color}\t{itm.PetName}");
